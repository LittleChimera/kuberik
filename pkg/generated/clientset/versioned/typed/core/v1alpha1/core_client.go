...
import (
	...
	"github.com/kuberik/kuberik/pkg/generated/clientset/versioned/scheme"
...
// CoreV1alpha1Client is used to interact with features provided by the core.kuberik.io group.
type CoreV1alpha1Client struct {
	restClient rest.Interface
}

func (c *CoreV1alpha1Client) Events(namespace string) EventInterface {
	return newEvents(c, namespace)
}

func (c *CoreV1alpha1Client) Movies(namespace string) MovieInterface {
	return newMovies(c, namespace)
}

func (c *CoreV1alpha1Client) Plays(namespace string) PlayInterface {
	return newPlays(c, namespace)
}

func (c *CoreV1alpha1Client) Screeners(namespace string) ScreenerInterface {
	return newScreeners(c, namespace)
}
